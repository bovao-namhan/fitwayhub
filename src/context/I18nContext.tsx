...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    strength: 'Strength', cardio: 'Cardio', hiit: 'HIIT', yoga: 'Yoga', stretching: 'Stretching', crossfit: 'CrossFit', pilates: 'Pilates', swimming: 'Swimming', running: 'Running', cycling: 'Cycling', boxing: 'Boxing', martial_arts: 'Martial Arts', calisthenics: 'Calisthenics', other_type: 'Other',
  ...
  ar: {
    ...
    strength: 'قوة', cardio: 'كارديو', hiit: 'تمارين عالية الشدة', yoga: 'يوغا', stretching: 'تمدد', crossfit: 'كروسفيت', pilates: 'بيلاتس', swimming: 'سباحة', running: 'جري', cycling: 'دراجة', boxing: 'ملاكمة', martial_arts: 'فنون قتالية', calisthenics: 'تمارين وزن الجسم', other_type: 'أخرى',
...
const egyptianWordMap: Array<[string, string]> = [
  ...
  ["التمارين", "التمرينات"],
  ["الفيديوهات", "الفيديوز"],
  ["الإشعارات", "النوتيفيكيشنز"],
  ["الدردشة", "الشات"],
  ["المجتمع", "الكوميونتي"],
  ["الأدوات", "التولز"],
  ["المظهر", "الثيم"],
  ["الوضع الداكن", "دارك مود"],
  ["الوضع الفاتح", "لايت مود"],
  ["اليوم", "النهارده"],
  ["غدا", "بكرة"],
  ["أمس", "امبارح"],
  ["دقائق", "دقايق"],
